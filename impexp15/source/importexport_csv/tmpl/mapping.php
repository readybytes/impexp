...
<div style="padding:0;border:2px solid #ccc;">
				...
				<div style="padding:0 10px;">
					<ol>
						...
						<li><?php echo JText::_('DATE_FIELD_MUST_BE_IN_SQL_FORMAT');?>
                                                    <a href="http://joomlaxi.com/support/documentation/item/importing-user.html" target="_blank">
						    <?php echo JText::_('CLICK_HERE');?></a><?php echo JText::_('TO_SEE_FORMAT');?>
						</li>
                        <li><?php echo JText::_('CSV_FILE_SHOULD_BE_IN_PROPER_FORMAT')?><a href="http://www.joomlaxi.com/support/documentation/item/importing-user.html" target="_blank"><?php echo JText::_('CLICK_HERE_FOR_HELP');?></a></li>
					</ol>			
					<br />
		<?php  
